...
replay path. Ships a 4-property harness suite covering authorization
(E6/E7), dispatch determinism (E14), bit-identical replay (A1), and PQC
Hybrid AND-mode dispatch logic (BOOLEAN-abstract model; cryptographic
correctness verified by integration tests in
...
| `kani_hybrid_and_mode_property` | PQC Hybrid AND-mode dispatch logic (BOOLEAN-abstract model) | 3 policy variants × 2 ed25519 × 2 mldsa65 = 12 cases |
