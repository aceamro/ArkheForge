...
//! hosts (M2.1 cycle, DIP-N6 Phase 2). Single source of truth for the
//! **E14.L2-Allow rule 1+2+4 anchor** (chain-effect-aware determinism
//! axis pinning).
...
/// **E14.L2-Allow rule 1+2+4 anchor** (M2.1 cycle, DIP-N6 Phase 2).
///
/// **E14.L2-Allow rules** (v0.12 sealing cut):
///
...
/// - **rule 3** — host-import allow-list — orthogonal axis, M2.3 scope
...
/// time. Canonical entrypoint for chain-effect-aware engine construction
/// (M2.1 EngineProfile factory unification, DIP-N6 Phase 2).
///
