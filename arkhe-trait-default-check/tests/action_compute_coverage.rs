...
//! method (auditor cross-review, Track A.1 Q2(ii); leader retroactive
//! adoption of Option γ — extension over a new sibling crate).
//!
...
//! ships as the workspace's MC structural-invariant syn scaffolding; D-USER-4
//! "do one thing well" reads workspace-wide structural invariant scan as a
//! single dimension covering both trait-default-body fingerprint and compute
//! coverage. Leader retroactively adopted this Option γ framing.
//!
